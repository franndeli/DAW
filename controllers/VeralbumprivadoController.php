<?php
// controllers/VeralbumprivadoController.php

require_once 'core/Controller.php';
require_once 'models/Album.php';
require_once 'models/Foto.php';

class VeralbumprivadoController extends Controller {
    private $albumModel;
    private $fotoModel;
    ...
    public function index() {
        ...
        $this->view('veralbumprivado', ['fotos' => $fotos, 'album' => $album, 'paises' => $paises, 'intervaloTiempo' => $intervaloTiempo]);
    }
}
